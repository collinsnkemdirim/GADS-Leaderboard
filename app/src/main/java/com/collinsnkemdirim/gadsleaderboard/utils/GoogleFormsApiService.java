...
public class GoogleFormsApiService {
    ...
    public static void submitProject(SubmitForm submitForm, @NonNull final ApiResponseCallback<Void> callback) {
        retrofitInterface.submitProject(submitForm.getFirstName(), submitForm.getLastName(), submitForm.getEmail(), submitForm.getProjectUrl())
